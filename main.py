...
if __name__ == '__main__':
    ...
    datasets = [("airlines", lambda: Airlines()), ("electricity", lambda: Elec2()),
                ("kdd99", lambda: KDD99()), ("wisdm", lambda: WISDM()),
                ("covtype", lambda: CovType()), ("nomao", lambda: Nomao()),
    ...
    data_name, data_generator = datasets[0]  # choose the dataset
    for (model_name, model) in models:
        ...
        avg_total_auc = np.mean(kappa_values)
