...
class ExperimentalHPT(HoeffdingTreeClassifier):
    ...
    def __init__(
        ...
        self.importance_average = utils.Rolling(stats.Mean(), window_size=1000)
    ...
    def _update_importance_threshold(self):
        ...
        self.importance_threshold = average_importance_value
